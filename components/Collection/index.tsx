...
export default function Collection() {
    return(
        <section className=" text-gray-700 bgcollection w-full h-auto md:h-collection "> 
            <img
            alt="title_roadmap" 
            className="mx-auto w-36 h-14 md:w-60 md:h-20 "
            src="./img/title_collection.png"/>
            <div className="overflow-y-auto h-auto w-full flex px-5  text-ijo lg:py-24 lg:px-20 m-auto py-12 md:py-4">
